    ...
    <div class="contents" style="padding-top: 70px;">
        ...
        <div class="imgdiv">
            <div id="contents">
                ...
                <h1><img style="margin-right:40%"src="https://www.sidiz.com/img/tl1/tl1_warranty.jpg" alt="A/S안내" style="position: relative;top:-3%;right:19%;"></h1>
                
                <div class="bar"><p></p></div>
                <h2><img style="margin-right:1.5%"  src="https://www.sidiz.com/img/tl2/tl2_warranty.jpg" alt="A/S 정책 안내"></h2>
                
                <div>
                
                    <div class="clearfix w1000" style="width: 1000px;">
            <p class="tct flt w1000" style="width: 1000px;"><img  style="margin-left: 34%;" src="https://www.sidiz.com/_upload/contents/1804/F1522644546084WOGHFDSCKPL.jpg" alt="A/S정책 안내" usemap="#map-CTX-03-002-1"></p>
                    <map name="map-CTX-03-002-1">
                        <area shape="rect" coords="91,326,226,360" href="client_fix.jsp">
                        <area shape="rect" coords="431,1309,566,1345" href="client_AS.jsp">
                        </map>
