        ...
        <div class="buybox">
            <div class="order_info">
                ...
                <div class="row">
                    ...
                    <div class="space_right">
                        <input class="order_name" type="text" title="이름" placeholder="이름" name="orderer_name" value="1234">
                    </div>
                    <div class="tel">
                        <input class="order_call" type="tel" title="연락처" placeholder="연락처" name="orderer_call" value="">
                    </div>
                    <div class="space_top">
                        <input class="order_email" type="email" title="이메일" placeholder="이메일" name="orderer_email" value="1234@1234.com">
                    </div>
                </div>
                <div class="trans_info">
                    ...
                    <div class="space_top">
                        <input class="order_email" type="text" title="국적" placeholder="대한민국" name="orderer" value="">
                    </div>
                    <div class="space_top">
                        <input class="order_email" type="text" title="주소" placeholder="주소" name="orderer" value="">
                    </div>
                    <div class="space_top">
                        <input class="order_email" type="text" title="상세주소" placeholder="상세주소" name="orderer value="">
                    </div>
                    <h3>배송 메모</h3>
                    <div class="space_top">
                        <input class="order_email" type="text" title="메모" placeholder="배송메모" name="orderer" value="">
                    </div>
                </div>
                <div class="buy">
                    <h3>결제 수단</h3>
                    ...
                    <div class="space_right">
                        <input class="order_email" type="text" title="이름" placeholder="입금자명(미입력시 주문자명)" name="orderer_name" value="">
                    </div>
                </div>
            </div>
            <div class="goods_info">
                ...
                <div class="product_img_wrap">
                    <img src="https://cdn.imweb.me/thumbnail/20161229/586469098af9c.jpg" width="58" height="58" alt="주문상품 이미지">
                </div>
                <div class="product_name">
                    <p>  Brooklyn Brine Fennel Beets</p>
                    <p> 총 <span style="margin-right: 50%;">1개</span></span> <span>   7000원</span></p>
                </div>
                <div class="product_price">
                    <p>  상품가격 <span>7000원</span></p>
                    <p> 배송비    2500원</span></p>
                </div>
                <div class="total_price">
                    <p>총 금액 <span>9500원</span></p>
                </div>
            </div>
        </div>
    </div>
