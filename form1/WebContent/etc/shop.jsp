        ...
        <div class="menu">
            ...
            <div class="listbox">
                <ul>
                    ...
                    <li><a href="clien_FQA.jsp">ETC</a></li>
                </ul>
                <div class="under_wrap" class="hide">
                    <div class="min_main">
                       <a href="boardList.bo"><strong>공지사항</strong></a>
                    </div>
                    <div class="min_shop">
                    ...
                    <div class="min_FAQ">
                        ...
                        <ul>
                            <li><a href="clien_FQA.jsp">FAQ</a></li>
                            <li><a href="client sangdam.jsp">친절상담</a></li>
                            <li><a href="client_AS.jsp">A/S신청</a></li>
                            <li><a href="client_AS_info.jsp">A/S안내</a></li>
