...
<body>
    ...
    <div class="contents">
        ...
        <p   class="tct flt w1000"><img style="margin-right:10%;" src="https://www.sidiz.com/_upload/contents/1401/F1389406978108WZGGXDBCCLS.jpg" alt="" usemap="#map-CTX-03-004-1"></p>
                <map name="map-CTX-03-004-1">
                    <area shape="rect" coords="14,167,152,200" href="client_AS_info.jsp">
                    <area shape="rect" coords="815,425,920,455" href="#">
                    </map>
                    <div class="tct">
                        <a style="margin-right:10%;" href="client_fix_go.jsp"><img src="https://www.sidiz.com/img/btn/btn_as_regist.png"></a>
                        <!-- <span id="stopRegister"><img src="/img/btn/btn_as_regist.png"/></span> -->
                    </div>
                </div>
        </div>
        </div>
