...
이 약관은 &lt;사이트 개설일&gt;부터 시행합니다.					</div>
    ...
    <div class="contents" style="padding-top:70px;">
        ...
        <div class="imgdiv">
            <p style="font-weight:bold;font-size:1.4em; color:#808082;">Q&A</p>
            <img src="https://www.sidiz.com/_upload/contents/1804/F1522644569643URMOLLUMSHZ.jpg">
            <!-- https://www.sidiz.com/customer/warranty -->
            <dl class="policy">
                <dd>
                    <p>
                        <span style="color: rgb(51, 51, 51); font-weight: bold;">개인정보의 수집 및 이용에 대한 안내</span>
                        <br>
                        <br>
                        <span>수집 항목 : 이름, 이메일, 휴대전화번호, IP주소, 주소(A/S문의)</span>
                        <br>
                        <span>수집 목적 : 상담 문의 접수 및 결과 회신, 서비스(A/S) 제공</span>
                        <br>
                        <span>이용 기간 : 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에 해당 정보를 지체 없이 파기합니다.</span>
                        <br>
                        <span style="margin-left: 70px;">단, 관계법령의 규정에 의하여 필요가 있는 경우 일정기간 동안 개인정보를 보관할 수 있습니다.</span>
                        <br>
                        <br>
                        <span>※ 위의 개인정보 수집 항목은 상담 접수 및 서비스 제공을 위한 최소한의 정보로,</span>
                        <br>
                        <span>&nbsp;&nbsp;   개인정보 수집에 동의하지 않으시는 경우 상담접수 및 서비스 제공이 불가능 합니다.</span>
                        <span><br>그 밖의 사항은 시디즈 개인정보처리방침을 준수합니다.</span>
                    </p>
                </dd>
                <dt class="inputfix">
            ...
            <table class="tbl2 inputfix">
				<!-- '고객의 소리' 개편				2018. 05. 28.  최현서 
				<tr>
					<th class="w130">문의구분</th>
					<td>
						<div class="selectBox">
							<select class="required" style="width:170px;" id="typeSelect" title="문의구분" name="qnaType" onchange="">
								<option value="">선택</option>
								<option value="A06001" >상품</option>
								<option value="A06002" >조립/AS</option>
								<option value="A06004" >주문/결제</option>
								<option value="A06005" >취소/환불</option>
								<option value="A06006" >반품/교환</option>
								<option value="A06007" >배송</option>
								<option value="A06008" >회원정보</option>
								<option value="A06009" >기타</option>
							</select></div>
						</td>
				</tr>
				-->
				<tbody><tr>
					<th class="w130">상품 구매전 문의</th>
					<td style="border-right:0px;"><input type="radio" name="radioQnaType" value="A06001">&nbsp;상품 정보</td>
					<td style="width:60%" colspan="3"><input type="radio" name="radioQnaType" value="A06010">&nbsp;상품 추천</td>
				</tr>
				<tr>
					<th class="w130">주문 관련 문의</th>
					<td style="border-right:0px;"><input type="radio" name="radioQnaType" value="A06004">&nbsp;주문/결제/취소</td>
					<td colspan="3"><input type="radio" name="radioQnaType" value="A06007">&nbsp;배송/방문설치</td>
				</tr>
				<tr>
					<th class="w130">상품 구매 후 문의</th>
					<td style="width:20%; border-right:0px;"><input type="radio" name="radioQnaType" value="A06011">&nbsp;사용 상 문의</td>
					<td style="width:20%; border-right:0px;"><input type="radio" name="radioQnaType" value="A06002">&nbsp;A/S 접수</td>
					<!-- 
					<td style="width:20%; border-right:0px;"><input type="radio" name="radioQnaType" value="A06012"/>&nbsp;부품 교체</td>
					 -->
					<td colspan="2" style="width:20%"><input type="radio" name="radioQnaType" value="A06005">&nbsp;반품/교환/환불</td>
				</tr>
				<tr>
					<th class="w130">기타 문의</th>
					<td style="border-right:0px;"><input type="radio" name="radioQnaType" value="A06013">&nbsp;상품 관련 매장</td>
					<td style="border-right:0px;"><input type="radio" name="radioQnaType" value="A06014">&nbsp;제안/칭찬/불만족</td>
					<td style="border-right:0px; width:20%;"><input type="radio" name="radioQnaType" value="A06008">&nbsp;회원정보</td>
					<td style="width:20%;"><input type="radio" name="radioQnaType" value="A06009">&nbsp;기타</td>
				</tr>
				<tr>
					<th class="w130">이름</th>
