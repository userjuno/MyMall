...
<body>
    ...
    <div class="contents">
        <div class="menu_nav">
            <P class="nav_p"><strong>고객센터 ></strong>
        ...
        <div id="contents">
            ...
            <h1><img src="https://www.sidiz.com/img/tl1/tl1_serial.jpg"  style="margin-left: 40%; margin-top: 5%;" alt="무상수리 보증기간 조회"></h1>
        
            <!-- 비회원 배송조회 -->
        
            <div class="bar"><p></p></div>
            <h2><img src="https://www.sidiz.com/img/tl2/tl2_serial2.jpg" style="margin-left: 43%; margin-top: 1%; margin-bottom: 2%;" alt="제품등록"></h2>
        
        
        
            <div class="inputfix">
        
                <form id="frm1" action="/customer/serial/registerSerialNo.do" method="post">
        
                <!-- 개인정보 수집 및 이용 동의 -->
                <dl class="policy">
                    <dd>
                        <p><span style="color: rgb(51, 51, 51); font-weight: bold;">개인정보의 수집 및 이용에 대한 안내</span>
        <br><br><span>수집 항목 : 성별, 연령</span><br>
        <span>수집 목적 : 제품구매 관련 통계자료로 활용 (비식별화)</span><br>
        ...
        <br><span>&nbsp;&nbsp;   개인정보 수집에 동의하지 않으시는 경우 제품등록이 불가능합니다.</span><br>
        <br><span>그 밖의 사항은 시디즈 개인정보처리방침을 준수합니다.</span></p></dd>
                    <dt>
                        <input style="margin-left: 41%;" type="checkbox" id="chk_policy" title="개인정보 수집 및 이용 동의가 필요합니다." class="required">
                        <label for="chk_policy">개인정보 수집 및 이용에 동의합니다.</label>
                    </dt>
                </dl>
        
                <p style="margin-left: 70%;">* 필수 입력 정보</p>
                <table class="tbl2">
                <tbody><tr>
                    <th class="w130">* 시리얼 넘버</th>
                    <td>
                        <input type="text" id="serialNo" title="시리얼 넘버" class="w150 required" value="" maxlength="16"> 	(- 포함) 	&nbsp;
                        <img style="vertical-align: middle;" src="https://www.sidiz.com/img/btn2/btn_question.png" >
                        <!-- class="hand" onclick="$('#l_serial').modal('show')" -->
                    </td>
                </tr>
                <tr>
                    <th>* 제품 구매처</th>
                    <td>
                        <p class="dropdown w200">
                        <select name="place" title="제품 구매처" class="w225 required">
                            <option value="">선택해주세요</option>
                            <option value="시디즈쇼핑몰">시디즈쇼핑몰</option>
                ...
                <tr>
                    <th>사용자 성별</th>
                    <td>
                        <input type="radio" name="gender" value="남" id="rad_gender1"> <label for="rad_gender1">남</label> &nbsp; &nbsp;
                        <input type="radio" name="gender" value="여" id="rad_gender2"> <label for="rad_gender2">여</label>
                    </td>
                </tr>
                <tr>
                    <th>사용자 연령</th>
                    <td>
                        <input type="text" name="age" title="사용자 연령" class="w40 numeric" maxlength="2"> &nbsp; 숫자만 사용하여 나이를 입력해 주세요.
                    </td>
                </tr>
                <tr>
                    <th>주 사용목적</th>
                    <td>
                        <p class="dropdown w200">
                        <select name="purpose" title="주 사용목적" class="w225">
                            <option value="">선택해주세요</option>
                            <option value="공부">공부</option>
                            <option value="PC작업">PC작업</option>
                ...
                <tr>
                    ...
                    <td>
                        <p class="dropdown w200">
                        <select name="route" title="시디즈를 알게 된 경로" class="w225">
                            <option value="">선택해주세요</option>
                ...
                <input type="hidden" name="erpSerialNo" value="">
                <input type="hidden" name="itemCd" value="">
                <input type="hidden" name="itemCol" value="">
                <input type="hidden" name="makeDts" value="">
                <input type="hidden" name="frDts" value="">
                <input type="hidden" name="toDts" value="">
            ...
            <!-- 더블클릭 방지 처리									2018. 06. 20.  최현서 -->
            <div class="tct" style="margin-left: 45.5%;">
                <div class="btn" id="btnDiv">
                    <img src="https://www.sidiz.com/img/btn/btn_as_regist2.png" onclick="onSubmit()" class="hand">
                </div>
                <div class="btn" id="progressDiv" style="display:none;color:#ff0000;">
                    처리중입니다. 잠시만 기다려주세요.
                </div>
            </div>
