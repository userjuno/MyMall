...
<style>
    ...
    .cartman{
        border-top: 1px rgb(114, 109, 109) solid ;
        text-align: center;
        padding-top: 50px;
        padding-bottom: 50px;
...
<body onLoad="regFrm.id.focus()">
    ...
    <div class="contents" style="padding-top: 70px;">
        <div class="cart"><h1>장바구니</h1>
        <table>
            <tr>
                <th class="item_info">item</th>
                <th class="wish">위시</th>
                <th class="amount">수량</th>
                <th class="del">배송수단</th>
                <th class="del_price">배송비</th>
                <th class="price">가격</th>
            </tr>
            <tr>

            </tr>
            <tr class="cartman" style="text-align: center; max-height: 20px;">
                
                <td style="text-align: left; max-height: 20px;">
                    <p  ><a href="goodsbox.jsp"><img src="https://cdn.imweb.me/thumbnail/20161229/5864690a13de9.jpg">Brooklyn Brine Fennel Beets</a></p>
        ...
        <a class="moreshop" href="doglist.dog">계속 쇼핑하기</a>
    </div>
    </div>
    <footer>
