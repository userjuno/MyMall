...
public class OrderBean {
	...
	public OrderBean(String goods_name, String buyer, String addr, String addr_more, String zipcode, String phone,
			String memo, int price, int trans_pay, int or_count, int totalMoney,String img,String order_date) {
		super();
	...
	public OrderBean(int order_no, String goods_name, String buyer, String addr, String addr_more, String zipcode,
