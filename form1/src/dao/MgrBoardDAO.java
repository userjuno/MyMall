...
public class MgrBoardDAO {
   ...
   DataSource ds;
   Connection con;
   private static MgrBoardDAO boardDAO;

   private MgrBoardDAO() {
      // TODO Auto-generated constructor stub
   }

   public static MgrBoardDAO getInstance(){
      if(boardDAO == null){
         boardDAO = new MgrBoardDAO();
      }
      return boardDAO;
   }
...
;
   ...
   public ArrayList<BoardBean> selectArticleList(int page,int limit){
	      ...
	      PreparedStatement pstmt = null;
	      ResultSet rs = null;
	      String board_list_sql="select * from user_board order by BOARD_RE_REF desc,BOARD_RE_SEQ asc limit ?,10";
   ...
   public ArrayList<UserBean> selectregList(){

	      PreparedStatement pstmt = null;
	      ResultSet rs = null;
	      String board_list_sql="select * from tblreg";
	      ...
	      try{
	         ...
	         while(rs.next()){
	            ...
	            board.setAddr(rs.getString("address"));
