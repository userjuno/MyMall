...
public class BoardDAO3 {
   ...
   DataSource ds;
   Connection con;
   private static BoardDAO3 boardDAO;
   ...
   public ArrayList<BoardBean> selectCommArticleList(int page,int board_num){

	      PreparedStatement pstmt = null;
	      ResultSet rs = null;
	      String board_list_sql="select * from comm_board where board_pnum=?  order by BOARD_RE_REF desc,BOARD_RE_SEQ asc ";
   ...
   public int updateArticle(BoardBean article){
	      ...
	      try{
	         ...
	         if(rs.next())
	            ...
	            num=1;
	         String sql="update free_board set board_pass=?,board_subject=?,board_content=?,board_date=now() where board_num=?";
...
;
   ...
   public ArrayList<BoardBean> selectArticleList(int page,int limit){
	      ...
	      PreparedStatement pstmt = null;
	      ResultSet rs = null;
	      String board_list_sql="select * from free_board order by BOARD_RE_REF desc,BOARD_RE_SEQ asc limit ?,10";
	      ArrayList<BoardBean> articleList = new ArrayList<BoardBean>();
	      BoardBean board = null;
	      int startrow=(page-1)*10; //읽기 시작할 row 번호..   
